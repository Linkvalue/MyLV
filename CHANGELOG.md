...
* **app:** Fix issue with holiday period counts ([091ba25](http://gitlab.com/LinkValue/Lab/CraCra/commit/091ba25))
* **holidays:** Fix day count for single day holiday requests ([3dd2408](http://gitlab.com/LinkValue/Lab/CraCra/commit/3dd2408))


### Features

* **app:** Move to yarn, add partner details, Webpack 4, rollback Babel 6 ([78398a1](http://gitlab.com/LinkValue/Lab/CraCra/commit/78398a1))
...
* **transport:** Fix proof of transport dialog and change name to MyLV ([69a9a77](http://gitlab.com/LinkValue/Lab/CraCra/commit/69a9a77))
...
* **worklog:** Fix white color for contribution label ([872fd67](http://gitlab.com/LinkValue/Lab/CraCra/commit/872fd67))


### Features

* **holidays:** Improve holidays with Easter calculation ([46ac617](http://gitlab.com/LinkValue/Lab/CraCra/commit/46ac617))
* **monitoring:** Add monitoring for cron jobs ([5ba2fb8](http://gitlab.com/LinkValue/Lab/CraCra/commit/5ba2fb8))
...
<a name="2.2.0"></a>
# [2.2.0](http://gitlab.com/LinkValue/Lab/CraCra/compare/v2.1.8...v2.2.0) (2018-04-11)


### Bug Fixes

* **app:** Fix app container when using latest MUI version ([fa08ea7](http://gitlab.com/LinkValue/Lab/CraCra/commit/fa08ea7))
* **auth:** Fixed issue with lvconnect auto refresh ([6594947](http://gitlab.com/LinkValue/Lab/CraCra/commit/6594947))
* **holidays:** Add holiday request details page ([3d24a77](http://gitlab.com/LinkValue/Lab/CraCra/commit/3d24a77))
* **holidays:** Fix multiple issues with holiday module ([f09ec5a](http://gitlab.com/LinkValue/Lab/CraCra/commit/f09ec5a))
* **holidays:** Fix pagination for holidays and partners pages ([a1047aa](http://gitlab.com/LinkValue/Lab/CraCra/commit/a1047aa))
* **holidays:** Fixed number of days counters for holiday requests ([a0e1181](http://gitlab.com/LinkValue/Lab/CraCra/commit/a0e1181))
* **holidays:** Fixed some display issues on holiday pages ([20b161e](http://gitlab.com/LinkValue/Lab/CraCra/commit/20b161e))
* **push:** Fix push notifications snack ([4266131](http://gitlab.com/LinkValue/Lab/CraCra/commit/4266131))
* **transport:** Close the proof of transport dialog on upload click ([e61d1cc](http://gitlab.com/LinkValue/Lab/CraCra/commit/e61d1cc))
* **transport:** Fix typo in transport modal ([45ced4a](http://gitlab.com/LinkValue/Lab/CraCra/commit/45ced4a))


### Features

* **drawer:** Better display for app drawer on mobile ([be5e7e5](http://gitlab.com/LinkValue/Lab/CraCra/commit/be5e7e5))
* **holidays:** Add approve and reject process for holiday requests ([0a0db00](http://gitlab.com/LinkValue/Lab/CraCra/commit/0a0db00))
* **holidays:** Add disclaimer text for holiday requests ([1d56f3b](http://gitlab.com/LinkValue/Lab/CraCra/commit/1d56f3b))
* **holidays:** Add holidays module ([ac935b8](http://gitlab.com/LinkValue/Lab/CraCra/commit/ac935b8))
* **holidays:** Add pagination for holidays admin ([f46c6b4](http://gitlab.com/LinkValue/Lab/CraCra/commit/f46c6b4))
* **lunches:** Move lunches view into personal universe ([5c034fb](http://gitlab.com/LinkValue/Lab/CraCra/commit/5c034fb))
* **offline:** Add full offline mode via Service Workers ([d656799](http://gitlab.com/LinkValue/Lab/CraCra/commit/d656799))
* **offline:** Fully support offline for better mobile device experience ([752a63e](http://gitlab.com/LinkValue/Lab/CraCra/commit/752a63e))
* **sw:** Add support for service worker auto-update ([01d8d94](http://gitlab.com/LinkValue/Lab/CraCra/commit/01d8d94))
